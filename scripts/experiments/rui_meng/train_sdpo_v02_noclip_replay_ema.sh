...
# SDPO v02 variant: EMA-smoothed teacher + no distillation IS clipping + training replay JSONL export.
# Based on train_sdpo_v02_noclip_replay.sh; see README_SDPO.md.
#
# Usage:
#   From repo root (recommended):
#     ./scripts/experiments/rui_meng/train_sdpo_v02_noclip_replay_ema.sh
#   Or from anywhere:
#     bash /path/to/Search-R1/scripts/experiments/rui_meng/train_sdpo_v02_noclip_replay_ema.sh
#
# Prerequisites:
...
#   TEACHER_REG — self-distillation teacher (default ema); use ema for this script
#   TEACHER_UPDATE_RATE — EMA blend rate (default 0.05, from ppo_trainer.yaml)
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-nq_sdpo-qwen2.5-3b-em-noclip-replay-ema}"
...
echo "train_sdpo_v02_noclip_replay_ema:"
