...
# OPD v02 variant with training replay JSONL export (one file per step).
# Based on train_opd_v02.sh; see README_OPD.md and README_SDPO.md (training replay format).
#
# Usage:
#   From repo root (recommended):
#     TEACHER_MODEL=Qwen/Qwen2.5-7B-Instruct ./scripts/experiments/rui_meng/train_opd_v02_replay.sh
#   Or from anywhere:
#     bash /path/to/Search-R1/scripts/experiments/rui_meng/train_opd_v02_replay.sh
#   Custom replay directory:
#     TRAIN_REPLAY_DIR=res/train_replays/my_opd_run \
#     ./scripts/experiments/rui_meng/train_opd_v02_replay.sh
#
# Prerequisites:
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-nq_opd-qwen2.5-3b-em-replay}"
