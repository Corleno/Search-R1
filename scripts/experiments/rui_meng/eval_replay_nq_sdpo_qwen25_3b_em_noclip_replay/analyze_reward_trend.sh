...
#   bash scripts/experiments/rui_meng/eval_replay_nq_sdpo_qwen25_3b_em_noclip_replay/analyze_reward_trend.sh
#
# Optional environment overrides:
#   REPLAY_DIR      — default: res/train_replays/nq_sdpo-qwen2.5-3b-em-noclip-replay
#   OUTPUT_DIR      — default: res/train_replay_analysis/nq_sdpo-qwen2.5-3b-em-noclip-replay
...
REPLAY_DIR="${REPLAY_DIR:-res/train_replays/nq_sdpo-qwen2.5-3b-em-noclip-replay}"
OUTPUT_DIR="${OUTPUT_DIR:-res/train_replay_analysis/nq_sdpo-qwen2.5-3b-em-noclip-replay}"
