...
# Parallel to train_sdpo_v02_test.sh and train_grpo_v02.sh (see README_SDPO.md).
# Search is enabled like GRPO/OPD v02.
#
# Usage:
#   From repo root (recommended):
#     ./scripts/experiments/rui_meng/train_sdpo_grpo_v02_test.sh
#   Or from anywhere:
#     bash /path/to/Search-R1/scripts/experiments/rui_meng/train_sdpo_grpo_v02_test.sh
#
# Prerequisites:
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-nq_sdpo-grpo-qwen2.5-3b-em-test}"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.self_distillation.filter_reprompt_before_update=false \
